      ...
      <Grid align="center" gutter="md">
        ...
        <Grid.Col span={{ base: 12, sm: "auto" }} className={classes.actions}>
          <Group justify="flex-end">
            <Button variant="default" leftSection={<IconFilter size={16} />} rightSection={<IconChevronDown size={16} />}>
              Filter
            </Button>
            <Button leftSection={<IconPlus style={{ width: rem(18), height: rem(18) }} />} onClick={onAddNew}>
              Add New
            </Button>
          </Group>
        </Grid.Col>
